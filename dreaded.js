...
const _0x803769 = _0x5449;
(function (_0x26fb4, _0x543c16) {
    const _0x7baa4a = _0x5449, _0x26d7aa = _0x26fb4();
    while (!![]) {
        try {
            const _0x21e579 = -parseInt(_0x7baa4a(0x189)) / (-0x257 * -0x2 + 0x15b * 0xf + -0x1902) * (parseInt(_0x7baa4a(0x179)) / (0xc16 + 0x7 * -0x9a + -0x7de)) + -parseInt(_0x7baa4a(0x18e)) / (-0x1 * 0x241a + 0x2 * -0xf2c + 0x4275) * (-parseInt(_0x7baa4a(0x182)) / (0x10a5 * 0x1 + 0x20c8 + -0x3169)) + parseInt(_0x7baa4a(0x17e)) / (-0xdfb + 0x3f * -0x33 + 0x1a8d) + parseInt(_0x7baa4a(0x17a)) / (-0x1 * 0x6ee + -0x152d + 0x17b * 0x13) + parseInt(_0x7baa4a(0x18d)) / (-0x1d30 + -0x238a + 0xb * 0x5e3) + -parseInt(_0x7baa4a(0x177)) / (-0x8 * 0xe + 0x14b0 + 0x2 * -0xa1c) + -parseInt(_0x7baa4a(0x17d)) / (-0x2125 + 0x1 * -0x1639 + -0x1 * -0x3767);
            if (_0x21e579 === _0x543c16)
                break;
            else
                _0x26d7aa['push'](_0x26d7aa['shift']());
        } catch (_0x5e932d) {
            _0x26d7aa['push'](_0x26d7aa['shift']());
        }
    }
}(_0x259e, 0x4099c * 0x2 + -0x1a22a3 + 0x200d8b * 0x1));
function _0x5449(_0x366662, _0x49a3d3) {
    const _0x1dbab3 = _0x259e();
    return _0x5449 = function (_0x527c54, _0x7ea879) {
        _0x527c54 = _0x527c54 - (0x19e1 + 0x47d * -0x5 + -0x1fc);
        let _0x33426c = _0x1dbab3[_0x527c54];
        return _0x33426c;
    }, _0x5449(_0x366662, _0x49a3d3);
}
if (!text)
    return reply(_0x803769(0x18c) + _0x803769(0x186) + _0x803769(0x17c) + _0x803769(0x18b) + _0x803769(0x175) + _0x803769(0x176) + _0x803769(0x174) + 'e!');
const {bardAI, bardAsk} = require(_0x803769(0x17f)), fs = require('fs');
let sessionCookies = JSON[_0x803769(0x180)](fs[_0x803769(0x188) + 'nc'](__dirname + (_0x803769(0x184) + _0x803769(0x187) + 'n')));
new bardAI(sessionCookies)[_0x803769(0x17b)]()[_0x803769(0x178)](() => {
    const _0x5639d8 = _0x803769, _0x83d7fd = {
            'Raeok': function (_0x2ed738, _0x4eaedf) {
                return _0x2ed738(_0x4eaedf);
            }
        };
    _0x83d7fd[_0x5639d8(0x181)](bardAsk, text)[_0x5639d8(0x178)](_0x53b30b => {
        const _0x3ce554 = _0x5639d8;
        console[_0x3ce554(0x185)](_0x53b30b), _0x83d7fd[_0x3ce554(0x181)](reply, _0x53b30b);
    })[_0x5639d8(0x183)](_0x128fbb => {
        const _0x12b1cd = _0x5639d8;
        console[_0x12b1cd(0x18a)](_0x128fbb);
    });
})[_0x803769(0x183)](_0xb947ad => {
    const _0x11943b = _0x803769;
    console[_0x11943b(0x18a)](_0xb947ad);
});
